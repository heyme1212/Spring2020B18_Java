...
public class StringLiterals {
    public static void main(String[] args) {
        ...
        /*
       The whole memory is called Java Heap
       Inside Java Heap there is String Pool where String duplicates can be saved in the same place
        in Java Heap we keep new Strings that are called.
         */
